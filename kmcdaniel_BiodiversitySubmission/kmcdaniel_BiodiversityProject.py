...
constatuses = species.groupby('conservation_status').scientific_name.nunique().reset_index()
constatuses
...
ax = plt.subplot()
plot = plt.bar(range(len(protection_counts.scientific_name))               , protection_counts.scientific_name)
...
print(chi2_contingency(contingency_2)[1])
...
print('Minimum Detectable Effect is ' +str(minimum_detectable_effect))
sample_size = 870
print('Sample size equals ' + str(sample_size))
...
bryce_weeks = 870 / 250
print ('Approximately ' + str(bryce_weeks) + ' weeks at Bryce')

yellowstone_weeks = 870 / 507
print ('Approximately ' + str(yellowstone_weeks) + ' weeks at Yellowstone')
